...
export interface ApiAboutCxcyAboutCxcy extends Struct.CollectionTypeSchema {
  collectionName: 'about_cxcies';
  info: {
    description: '';
    displayName: '\u521B\u65B0\u521B\u4E1A';
    pluralName: 'about-cxcies';
    singularName: 'about-cxcy';
  };
  options: {
...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    company_factory: Schema.Attribute.Media<
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    introduces: Schema.Attribute.Component<'shared.company-profile', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    products_technologies: Schema.Attribute.Component<
      'shared.products-technologies',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
    scale: Schema.Attribute.Component<'shared.scale', true>;
    scale_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    slide: Schema.Attribute.Media<
      ...
      true
    >;
    title_choose: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    background_pattern: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    ...
    feature_icon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    feature_label: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::job.job'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'shared.sections-repeatable', true>;
...
export interface ApiNewsNews extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    news_cover: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-cxcy.about-cxcy': ApiAboutCxcyAboutCxcy;
